...
class VideoChatViewActivity : AppCompatActivity() {
    ...
    fun onLocalVideoMuteClicked(view: View) {
        ...
        if (iv.isSelected) {
            ...
            iv.isSelected = true
            iv.setColorFilter(resources.getColor(R.color.disabled), PorterDuff.Mode.MULTIPLY)
        }
    ...
    private fun joinChannel() {
        ...
        mRtcEngine!!.joinChannel(token, getString(R.string.agora_channel), "Extra Optional Data", 0) // if you do not specify the uid, we will generate the uid for you
    }
